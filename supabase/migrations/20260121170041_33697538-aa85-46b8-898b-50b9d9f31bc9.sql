-- Update the admin_correct_event_amount function to work without superuser privileges
-- We'll modify the trigger to allow corrections via this specific function
...
BEGIN
  ...
  CREATE TRIGGER prevent_approved_modification
